...
class CheckoutController extends Controller
{
    ...
    public function index()
    {
        ...
        Stripe::setApiKey('sk_test_KMO1osSpwaWqxIYuQT37uwdz00cQ3zT2b7');
    ...
    public function store(Request $request)
    {
       if ( $this->checkIfNotAvailable()) {
        ...
        //    Session::flash('success','Votre commende a été traitée avec succès');
        ...
        $order->payment_create_at=(new DateTime())
                ...
                foreach (Cart::content() as $product) {
                    ...
                    // $products['product_'.$i][]=$product->model->Cart::tax(); 
                    $i++;
                }
    ...
    {
     return Session::has('success') ? view('checkout\merci') : redirect()->route('products.index');
    }
